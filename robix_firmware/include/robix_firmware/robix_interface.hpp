#ifndef ROBIX_INTERFACE_HPP
#define ROBIX_INTERFACE_HPP_INTERFACE_HPP
...
namespace robix_firmware
{

using CallbackReturn = rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn;

class RobixInterface : public hardware_interface::SystemInterface
{
public:
  RobixInterface();
